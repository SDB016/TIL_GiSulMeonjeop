...
# RPC    
별도의 원격 제어를 위한 코드 없이 원격으로 메서드나 프로시저를 호출할 수 있게끔 만드는 통신     
RPC는 직렬화된 바이트 스트림을 이용하기 때문에 JSON 보다 빠르다는 장점이 있습니다.          
구글의 GRPC 같은 경우는 C/C++ 뿐만 아니라 Java/python 같은 다양한 언어도 사용 가능한 장점이 있습니다.       
